    ...
    class YChartsExcelScraper
    {
        ...
        public void AddDataNameRowVariableMappingsCurDoc(string sheetName)
        {
            ...
            else if (sheetName.Equals("Quarterly Income Statements"))
            {
                ...
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Minority Interest", "is_minority_interest"), 20);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Minority Interest", "is_minority_interest1"), 21);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Equity In Affiliates", "is_equity_in_affiliates"), 22);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Income Before Extraordinaries & Disc. Operations", "is_income_before_disc_operations"), 23);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Investment Gains/Losses", "is_investment_gains_losses"), 24);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Other Income/Charges", "is_other_income_charges"), 25);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Income from Discontinued Operations", "is_income_from_disc_operations"), 26);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Net Income", "is_net_income"), 27);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Average Shares to compute diluted EPS", "is_average_shares_diluted_eps"), 29);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("Average Shares used to compute basic EPS", "is_average_shares_basic_eps"), 30);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("EPS - Basic net", "is_eps_basic"), 31);
                _dataNameRowVariableMappings.Add(new KeyValuePair<string, string>("EPS - Diluted net", "is_eps_diluted"), 32);
            }
        }
    }
}
